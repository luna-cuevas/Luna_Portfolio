...
const Hero = () => {
	...
	C90.9,148.7,8.7,129.4,8,102.6c-0.6-18.5,38-35.8,95.2-45.7"/>
                        <circle id='realmoon'  ref={moonRef}  cx="184.2" cy="36.1" r="12.9" x="0px" y="0px"/>
                    </svg>
                    <div className='intro'>
                        <h1 style={{background: '#1b041b'}} title="Luna Cuevas">Luna Cuevas</h1>
                    ...
                    <div style={{background: '#1b041b'}} className="hero-p">
